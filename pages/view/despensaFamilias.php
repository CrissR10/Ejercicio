...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicio: Despensa a familias | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Despensa a familias</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="../../index.php"><i class="fas fa-arrow-left"></i> Inicio</a>
                        </li>
                        <li>Despensa a familias</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-5 div-info-video">
                        <h3 class="section-title section-title-border-half text-white">Servicio: Despensa a familias.</h3>
                        <div>
                            <ul class="pl-3 d-inline-block float-sm-left mr-sm-5">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    ...
                                    La ayuda se les da a madres solteras, viudas o sin empleo, también se les hace la entrevista y si es necesario se les apoya por meses y hasta por años, también se lleva un control, con algunos voluntarios.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div style="float:right;">
                            <a href="despensaAncianos.php" class="prevArrowS" title="Anterior: Despensas a adultos mayores"><i class="fas fa-angle-left fa-2x"></i></a>
                            <a href="bazarRopa.php" class="nextArrowS" title="Siguiente: Bazar de ropa"><i class="fas fa-angle-right fa-2x"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/despensaFamilias/1-despensaFamilias.png);">
