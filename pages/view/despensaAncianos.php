...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicio: Despensas a adultos mayores | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Despensas a adultos mayores</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="../../index.php"><i class="fas fa-arrow-left"></i> Inicio</a>
                        </li>
                        <li>Despensas a adultos mayores</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-5 div-info-video">
                        <h3 class="section-title section-title-border-half text-white">Servicio: Despensas a adultos mayores.</h3>
                        <div>
                            <ul class="pl-3 d-inline-block float-sm-left mr-sm-5">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    ...
                                    El apoyo se da una vez a personas de la tercera edad en extrema pobreza, se lleva un registro, antes se le hace una entrevista para conocer su situación, familiar, económica y de salud, también se les hace visita domiciliaria, para tener más conocimiento de su situación.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div style="float:right;">
                            <a href="consultasPsicologicas.php" class="prevArrowS" title="Anterior: Consultas psicológicas"><i class="fas fa-angle-left fa-2x"></i></a>
                            <a href="despensaFamilias.php" class="nextArrowS" title="Siguiente: Despensa a familias"><i class="fas fa-angle-right fa-2x"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/despensaAncianos/1-despensaAncianos.png);">
