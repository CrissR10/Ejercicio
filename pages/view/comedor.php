...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicio: Comedor | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Comedor</h2>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-5 div-info-video">
                        <h3 class="section-title section-title-border-half text-white">Servicio: Comedor.</h3>
                        <div>
                            <ul class="pl-3 d-inline-block float-sm-left mr-sm-5">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    ...
                                    Este servicio que dará Cáritas, será de mucha ayuda a personas que andan en la calle, hemos notado que, en las nuevas instalaciones, acude más gente con esa necesidad, nos viene a solicitar comida preparada, personas que van de paso o que viene a Córdoba por alguna consulta o indigentes, la fecha para abrir el comedor despende de que las instalaciones estén preparadas y tengamos el personal voluntario, porque se requiere de más participación de personas que nos apoyen a  dar un servicio de calidad y calidez.  
                                </li>
                            </ul>
                        </div>
                        ...
                        <div style="float:right;">
                            <a href="emergencias.php" class="prevArrowS" title="Anterior: Emergencias"><i class="fas fa-angle-left fa-2x"></i></a>
                            <a href="serviciosVarios.php" class="nextArrowS" title="Siguiente: Servicios varios"><i class="fas fa-angle-right fa-2x"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/comedorPobres/1-comedorPobres.png);">
