...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicio: Farmacia | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Farmacia</h2>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-5 div-info-video">
                        <h3 class="section-title section-title-border-half text-white">Servicio: Farmacia.</h3>
                        <div>
                            <ul class="pl-3 d-inline-block float-sm-left mr-sm-5">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    ...
                                    Es el servicio que Cáritas brinda a los hermanos que necesitan medicinas después de haber recibido atención médica en esta Institución o en otro lugar. 
                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Cumpliendo a su máxima capacidad, el servicio que también se conoce como “Dispensario”, se atiende directamente al solicitante y también se comparte medicina y material de curación con dispensarios médicos de parroquias de la periferia urbana y con reclusos enfermos.
                                </li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/farmacia/1-farmacia.png);">
