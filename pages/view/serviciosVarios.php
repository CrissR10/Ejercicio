...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicio: Servicios varios | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Servicios varios</h2>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-5 div-info-video">
                        <h3 class="section-title section-title-border-half text-white mb-3">Servicio: Servicios varios.</h3>
                        <div>
                            <ul class="pl-3 d-inline-block float-sm-left mr-sm-1">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Apoyos económicos y en especie (ataúdes) para funerales a personas de escasos recursos.
                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Préstamo o donación de sillas de ruedas, bastones, andaderas y otros aparatos ortopédicos.
                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Compra de boletos para viajar a consultas o tratamientos fuera de la ciudad.
                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Pago de hemodiálisis a personas de escasos recursos.
                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Pago de estudios de gabinete (laboratorio, rayos X, etc.)
                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Compra de medicamentos especializados, alimentos, material de curación y otros insumos en caso de intervención quirúrgica, siempre dependiendo de las posibilidades de Cáritas y de la necesidad real de los solicitantes.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div style="float:right;">
                            <a href="comedor.php" class="prevArrowS" title="Anterior: Comedor"><i class="fas fa-angle-left fa-2x"></i></a>
                            <!-- <a href="comedor.php" class="nextArrowS" title="Siguiente: Comedor"><i class="fas fa-angle-right fa-2x"></i></a> -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/serviciosVarios/1-serviciosVarios.png);">
