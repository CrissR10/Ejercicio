...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicio: Consultas médicas | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Consultas médicas</h2>
                    <ol class="breadcrumb">
                        <li>
            ...
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-5 div-info-video">
                        <h3 class="section-title section-title-border-half text-white">Servicio: Consultas médicas.</h3>
                        <div>
                            <ul class="pl-3 d-inline-block float-sm-left mr-sm-5">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    ...
                                    Este es uno de los servicios con mayor demanda, de los más amplios y la más necesitada de apoyo. Esto es posible gracias a doctores generosos que se acercan a ofrecer sus servicios de manera voluntaria, a veces una o dos horas por semana.  Además de la consulta ordinaria cuando es necesario se canaliza a las personas de muy bajos recursos a especialistas o a hospitales para su atención.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div style="float:right;">
                           <a href="farmacia.php" class="prevArrowS" title="Anterior: Farmacia"><i class="fas fa-angle-left fa-2x"></i></a>
                           <a href="consultasPsicologicas.php" class="nextArrowS" title="Siguiente: Consultas psicológicas"><i class="fas fa-angle-right fa-2x"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/consultasMedicas/1-consultasMedicas.png);">
