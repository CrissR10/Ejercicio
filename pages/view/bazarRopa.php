...
<head>
    ...
    ?>
    <!-- Titulo de la pagina -->
    <title>Servicio: Bazar de ropa | Cáritas Córdoba A.C.</title>
</head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h2 class="text-white font-weight-bold">Bazar de ropa</h2>
                    <ol class="breadcrumb">
                        <li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 px-0 pl-0">
                    <div class="p-sm-5 pl-5 py-1 div-info-video">
                        <h3 class="section-title section-title-border-half text-white mb-4">Servicio: Bazar de ropa.</h3>
                        <div>
                            <ul class="pl-3 pr-0 d-inline-block float-sm-left mr-sm-0">
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    Es el de compartir diversos artículos recibidos en donación como ropa, zapatos, línea blanca, utensilios de cocina y enseres domésticos. Se le ha llamado “Bazar”. Se pide a los donadores que la ropa se encuentre limpia y en buen estado pues se otorga a personas con diferentes situaciones.
                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    <b><u>Para que los solicitantes la vendan:</u></b>
                                    Cuando necesitan efectivo para pagar medicinas, gastos de hospitalización o funerarios, renta y otros de primera necesidad.
                                    En caso de tener en la familia un enfermo crónico o en fase terminal cuya atención les impide tener un empleo formal y necesitan tener ingresos pues las medicinas y los alimentos son caros.

                                </li>
                                <li class="font-secondary mb-10 text-white text-justify">
                                    <i class="text-primary mr-2 ti-arrow-circle-right"></i>
                                    <b><u>Para que los solicitantes la usen:</u></b>
                                        Se dona a personas de escasos recursos, de colonias marginadas o comunidades rurales, a indigentes.
                                </li>
                            </ul>
                        </div>
                        ...
                        <div style="float:right;">
                            <a href="despensaFamilias.php" class="prevArrowS" title="Anterior: Despensa a familias"><i class="fas fa-angle-left fa-2x"></i></a>
                            <a href="emergencias.php" class="nextArrowS" title="Siguiente: Emergencias"><i class="fas fa-angle-right fa-2x"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mx-0 align-self-center img-back-div" style="background-image: url(../../src/img/servicios/bazarRopa/1-bazarRopa.png);">
